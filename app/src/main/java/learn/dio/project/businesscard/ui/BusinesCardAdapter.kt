...
import learn.dio.project.businesscard.databinding.ItemBusinessCardBinding

class BusinesCardAdapter :
    ListAdapter<BusinessCard,BusinesCardAdapter.ViewHolder>(DiffCallback()) {
